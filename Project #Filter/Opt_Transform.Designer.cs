namespace Project__Filter
{
    partial class Opt_Transform
    {
        ...
        private void InitializeComponent()
        {
            ...
            radioButton_Size.Location = new Point(224, 148);
            radioButton_Size.Margin = new Padding(3, 2, 3, 2);
            radioButton_Size.Name = "radioButton_Size";
            radioButton_Size.Size = new Size(115, 25);
            ...
            radioButton_Date.Location = new Point(18, 148);
            radioButton_Date.Margin = new Padding(3, 2, 3, 2);
            radioButton_Date.Name = "radioButton_Date";
            radioButton_Date.Size = new Size(120, 25);
            ...
            radioButton_Name.Location = new Point(18, 98);
            radioButton_Name.Margin = new Padding(3, 2, 3, 2);
            radioButton_Name.Name = "radioButton_Name";
            radioButton_Name.Size = new Size(129, 25);
            ...
            comboBox_Select.Items.AddRange(new object[] { "IMAGE To PDF [TITLE]", "IMAGE To PDF [NO TITLE]", "IMAGE To ICO", "IMAGE To WEBP", "IMAGE To BMP", "VIDEO To GIF", "VIDEO To WEBM", "VIDEO To AVI", "VIDEO To AUDIO", "AUDIO To WAV", "DOC To PDF" });
